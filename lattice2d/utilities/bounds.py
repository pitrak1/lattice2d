...
def within_rect_bounds(start_position, end_position, dimensions):
	valid_x = end_position[0] > start_position[0] - dimensions[0] // 2 and end_position[0] < start_position[0] + dimensions[0] // 2
	valid_y = end_position[1] > start_position[1] - dimensions[1] // 2 and end_position[1] < start_position[1] + dimensions[1] // 2
